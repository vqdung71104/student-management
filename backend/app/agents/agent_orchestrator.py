...
LLM_REASONING_TIMEOUT = float(os.environ.get("LLM_REASONING_TIMEOUT", "50.0"))
TOOL_EXECUTION_TIMEOUT = float(os.environ.get("TOOL_EXECUTION_TIMEOUT", "100.0"))
AGENT_REASONING_TIMEOUT = float(os.environ.get("AGENT_REASONING_TIMEOUT", "50.0"))
...
OPENAI_GENERATE_TIMEOUT = float(os.environ.get("OPENAI_GENERATE_TIMEOUT", "50.0"))
