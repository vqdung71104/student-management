        ...
        <div className="p-6">
          <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm text-blue-800">
              <li>Truy c?p https://ctt.hust.edu.vn/ và dang nh?p</li>
              <li>Ch?n: D?ch v?  K?t qu? h?c t?p  Ði?m cá nhân</li>
              <li>Sao chép toàn b? b?ng di?m và dán vào trang tính Excel tr?ng</li>
              <li>Luu t?p Excel và t?i lên dây</li>
            </ol>
            <div className="mt-3 text-xs text-blue-700 bg-white p-2 rounded">
              <strong>Ð?nh d?ng file:</strong> D? li?u b?t d?u t? c?t A (không c?n tiêu d?)<br />
              <strong>Th? t? c?t:</strong> A=H?c k?, B=Mã HP, C=Tên HP, D=S? tín ch?, E=Ði?m ch?
            </div>
          </div>
              ...
              {!file ? (
                <div>
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-2 text-sm text-gray-500">H? tr? các t?p .xlsx, .xls</p>
                  </div>
                </div>
              ) : (
                <div>
                  <div className="text-green-600 mb-2">File dã ch?n: {file.name}</div>
          ...
          {loading && progress.total === 0 && (
            <div className="text-center py-4">
              ...
              <p className="mt-2 text-gray-600">Ðang x? lý t?p...</p>
            </div>
          )}
          ...
          {preview.length > 0 && !loading && (
            <div className="mb-6">
                ...
                <table className="min-w-full bg-white text-sm">
                  <thead className="bg-gray-50 sticky top-0">
                    <tr>
                      ...
                      <th className="px-4 py-2 text-left">Mã h?c ph?n</th>
                      <th className="px-4 py-2 text-left">Tên h?c ph?n</th>
                      <th className="px-4 py-2 text-left">S? tín ch?</th>
                      <th className="px-4 py-2 text-left">Ði?m ch?</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <p className="text-sm text-gray-600 mt-2">T?ng c?ng: {preview.length} môn h?c</p>
            </div>
          )}
